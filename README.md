...
1.Найдены химические компоненты, наиболее влияющие на алкогольность вина
2. Построен корреляционный анализ между признаками
3. Выявлены паттерны, влияющие на качество вина
4. Создана ML-модель, которая предсказывает характеристики вин по химическим параметрам
5. Получены визуализации, подтверждающие зависимости в данных
